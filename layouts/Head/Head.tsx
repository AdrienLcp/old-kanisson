...
export const NextHead: FC<HeadProps> = ({
  ...
  return (
    <Head>
      ...
      <meta property="og:image" content="https://www.kanisson.com/favicon/favicon-512x512.png" />
      ...
      <meta name="twitter:image" content="https://www.kanisson.com/favicon/favicon-512x512.png" />
